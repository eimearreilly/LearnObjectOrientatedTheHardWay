...
public class Ex55DropGameGUI extends Application {
    private GraphicsContext gc;
    private int player = 1;
    private Ex42DropGameHelper game;
    private boolean started = false;
    private boolean gameOver = false;
    private Ex41Location[][] locs;
    ...
    public void start(Stage stage) {
        ...
        game = new Ex42DropGameHelper(6, 7);
        locs = new Ex41Location[6][7];
        for (int r = 0; r < locs.length; r++)
            for (int c = 0; c < locs[0].length; c++)
                locs[r][c] = new Ex41Location(r, c);
