...
public class Ex30ReferenceParameters {
    ...
    //new method
    // create new array with one less space DONE.
    // Then fill the array with values one larger the the original array
    // i.e. { 1, 4, 9, 25, 36 } to {2 ,5 , 10, 26}
    public static int[] smallerIncrementArray(int[] arr){
