...
public class Ex26SortingSpeeds {
    public static void main(String[] args){
        ...
        for(int runs=0; runs<iterations; runs++){
            ...
            if ( choice == 1 ) {
                testDescription = "primitive ints using selection sort"; start = System.nanoTime(); selectionSortPrimitives(intArr);
                ...
                testDescription = "Array of primitive integers Arrays.sort()";
                start = System.nanoTime();
                Arrays.sort(intArr);
                stop = System.nanoTime();
            }
            elapsed = (stop-start)/1000000;
            if ( runs > 10 && elapsed < fastest ) fastest = elapsed;
            if ( runs > 10 && elapsed > slowest ) slowest = elapsed;
        }
