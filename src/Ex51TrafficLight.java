...
public class Ex51TrafficLight extends Application {
    @Override
    public void start(Stage stage) {
        ...
        scene.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                if ( circle1.contains(t.getX(), t.getY()) ) label.setText("You clicked on the red circle!");
                else if ( circle2.contains(t.getX(), t.getY()) ) label.setText("You clicked on the yellow circle!");
                else if ( circle3.contains(t.getX(), t.getY()) ) label.setText("You clicked on the green circle!");
                else
