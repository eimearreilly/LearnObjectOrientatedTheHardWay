...
public class Ex16ArrayListIntro {
    public static void main(String[] args) {
        ...
        // Create a second ArrayList of Strings at the bottom of main(). Add three or four values to it,
        // remove at least one value, then display the state of the ArrayList using either the showList()
        // function or by just printing it.
