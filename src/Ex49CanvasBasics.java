...
public class Ex49CanvasBasics extends Application {
    @Override
    public void start(Stage stage) {
        ...
        // Add code to draw a filled-in red square in the lower-right-hand corner of the canvas.
        gc.fillRect(400,500,50,50);
